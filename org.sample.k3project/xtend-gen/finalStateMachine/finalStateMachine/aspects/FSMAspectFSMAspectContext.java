...
public class FSMAspectFSMAspectContext {
  ...
  public static FSMAspectFSMAspectProperties getSelf(final FSM _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new finalStateMachine.finalStateMachine.aspects.FSMAspectFSMAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<FSM, FSMAspectFSMAspectProperties> map = new java.util.WeakHashMap<finalStateMachine.FSM, finalStateMachine.finalStateMachine.aspects.FSMAspectFSMAspectProperties>();
